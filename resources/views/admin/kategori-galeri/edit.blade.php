...
<div class="card card-modern border-0 shadow-sm">
    <div class="card-header bg-transparent border-0 pt-4 pb-0">
        <h5 class="fw-bold mb-0">Edit Kategori: {{ $kategori_galeri->nama }}</h5>
    </div>
    <div class="card-body">
        <form action="{{ route('admin.kategori-galeri.update', $kategori_galeri->id) }}" method="POST">
            @csrf
            @method('PUT')
            
            @include('admin.kategori-galeri.form', ['item' => $kategori_galeri])
